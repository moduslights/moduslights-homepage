          ...
          <Row className="no-gutters">
            ...
            <Col
              ...
              <div className="p-4 text-center p-lg-5">
                <div className="hover-scale-rounded">
                  <h1 className="display-4 font-weight-bold mb-4">Trust</h1>
                  <p
                    className="font-size-xl text-white-50"
                    style={{ lineHeight: '1.9', letterSpacing: '1.7' }}>
                    We are a team of responsible, accountable and caring people
                    that you can trust. This is how we continue to do great
                    things together. We practice paired designs, reviews,
                    engagements and even programming on many projects, inspiring
                    a great sense of camaraderie along the way.
                  </p>
                </div>
              </div>
            </Col>
